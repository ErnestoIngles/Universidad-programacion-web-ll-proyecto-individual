...
import { Card, Badge, Modal, Button, ModalFooter } from "react-bootstrap";
      ...
      >
        ...
        <div className="ratio ratio-1x1 bg-light" style={{ overflow: "hidden" }}>
          {producto.imagen_url ? (
            ...
            <div className="d-flex align-items-center justify-content-center h-100 bg-secondary-subtitle">
          ...
          <div className="row g-4">
            ...
            <div className="col-md-7">
              <div className="d-flex align-items-center mb-3">
                <Badge bg="secondary" pill className="mb-2">
                  {categoriaNombre || "Sin categoría"}
                </Badge>
              </div>
